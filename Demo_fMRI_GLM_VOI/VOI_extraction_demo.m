function VOI_extraction_demo(VOI_name, contr4adj, contr4act, thrs, mask_abs_path, geometry, center, dimension)
%-----------------------------------------------------------------------
...
% -------------------------------------------------------------------------
matlabbatch{1}.spm.util.voi.roi{1}.spm.spmmat ={'SPM.mat'}; %new! Usually i left it empty
...
matlabbatch{1}.spm.util.voi.expression =  'i1 & i3'; %'i1 & i3';
