...
% % added _25 for debug of filtering - May 22 2025

%input_split = fullfile(pwd, native_fMRI)
input_split = fullfile(pwd, 'Preproc_fMRI', native_fMRI)

disp('I am splitting volumes')

mkdir('Preproc_fMRI/splits_25'); cd('Preproc_fMRI/splits_25')
...
mkdir('Preproc_fMRI/wsplits_mni2mm_25');
!gzip -f Preproc_fMRI/splits_25/*.nii
!mv Preproc_fMRI/splits_25/w*.nii.gz Preproc_fMRI/wsplits_mni2mm_25
%!gzip -f Preproc_fMRI/splits_25/f*.nii
