...
outputDir = fullfile(protDir,'Group_analysis_25');
...
for subject=start_subj:nsubj
    ...
    if isfile(fullfile(protDir,name,'Functional','stats_2025','con_0001.nii'))
        contrast{cont,1} = horzcat(fullfile(protDir,name,'Functional','stats_2025','con_0001.nii'),',1');
        cont = cont+1;
    end
end
