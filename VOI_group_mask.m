function VOI_group_mask(protDir, VOI_name, contr4adj, thrs, mask_abs_path, geometry, center, dimension)
%-----------------------------------------------------------------------
...
% Name of the VOI. Call it name_of_the_region__number__side
