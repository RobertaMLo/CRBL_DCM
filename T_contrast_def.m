function T_contrast_def(parent_dir, start_subj, nsubj, contr_name, contr_mat, del_contr)
% =========================================================================
...
for subject=start_subj:nsubj
        ...
        if isfolder( fullfile(parent_dir,name) )
            ...
            matlabbatch{1}.spm.stats.con.consess{1}.tcon.name = contr_name;
            matlabbatch{1}.spm.stats.con.consess{1}.tcon.weights = contr_mat;
